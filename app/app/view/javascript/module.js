var myApp = angular.module('myApp', ["Layout", "schemaForm", "WsClient", "HttpClient", "DataService", "Display", "Map", "Chart", "Grid", "Gauge", "ngTagsInput", "gridster", "Button", "Accelerometer", "ui.bootstrap", "ngRoute", "pascalprecht.translate", "ui.select", "ui.codemirror", 'schemaForm-datepicker', 'schemaForm-timepicker', 'schemaForm-datetimepicker', 'ngMaterial', "ngAnimate"]);
