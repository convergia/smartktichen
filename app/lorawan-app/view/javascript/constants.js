myApp.constant("constants", {
 ...
 login: {
    ...
    "logo": '//convergia-cdn.s3.amazonaws.com/logo-450.png',
  ...
  infoWindows: {
    "icons": {
      "cxc": '<img style="width:50px;height:50px" src="https://convergia-cdn.s3.amazonaws.com/cxcagriculture/cxc_agriculture.png">',
      "cxc_bat": '<img style="width:30px;height:30px" src="https://convergia-cdn.s3.amazonaws.com/battery.png">',
      "cxc_time": '<img style="width:20px;height:20px" src="https://convergia-cdn.s3.amazonaws.com/time.png">',
